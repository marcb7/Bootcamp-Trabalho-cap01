package com.bootcamp.trabalho01.resources;
...
import com.bootcamp.trabalho01.services.ClientService;
...
public class ClientResource {
	...
	public ResponseEntity<Page<ClientDTO>> findAllClients(
		...
		Page<ClientDTO> listClients = clientService.findAllClientsPaged(pageRequest);
